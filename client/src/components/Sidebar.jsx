...
const Sidebar = ({sidebarOpen, setSidebarOpen}) => {
  ...
  return (
    <div className={`w-64 xl:w-72 bg-indigo-900 border-r border-gray-200 flex flex-col justify-between items-center max-sm:absolute top-0 bottom-0 z-20 ${sidebarOpen ? 'translate-x-0' : 'max-sm:-translate-x-full'} transition-all duration-300 ease-in-out`}>
      ...
      <div className='w-full border-t border-gray-200 p-4 px-7 flex items-center justify-between'>
        <div className='flex gap-2 items-center cursor-pointer' onClick={() => navigate('/profile')}>
          <img src={user.profile_picture || '/default-avatar.png'} alt="Profile" className='w-8 h-8 rounded-full'/>
          <div>
